...
class WallFollowingBot(Node):
    def __init__(self):
        super().__init__('wall_follwing')  # name of the node
        # publisher
    ...
    def get_scan_values(self, scan_data):
        ...
        print(round(self.region_3, 3), "/", round(self.region_2, 3), "/",
              round(self.region_1, 3), "/", round(self.velocity.angular.z, 3), "/", self.case)
    ...
    def proporitonal_control(self):
        ...
        # -98.8 , which if given as take angular velocity will cause errors so
